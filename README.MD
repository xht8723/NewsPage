...
For instructions on how to build and run the application, please see the [NewsPage/README.md](NewsPage/README.md) file.
...
* [ ] Implement detailed view for full summaries and and original source links.
